 ...
 *
 * Maps algorithm names to their quantum safety profile,
 * PQC replacement recommendations, and notes.
 *
 * Extracted from pqcRiskEngine.ts for maintainability.
 */
import { QuantumSafetyStatus } from '../../types';
import type { AlgorithmProfile } from './types';

export const ALGORITHM_DATABASE: Record<string, AlgorithmProfile> = {
