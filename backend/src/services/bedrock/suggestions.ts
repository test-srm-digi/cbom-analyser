 ...
 *
 * Per-asset quantum-safe migration suggestions using AWS Bedrock
 * with intelligent local fallback.
 */
import type { BedrockSuggestionRequest, BedrockSuggestionResponse } from './types';
