...
import type { Tab, DashboardPageProps } from './dashboard/types';
import { formatDate } from './dashboard/utils';
import { WelcomeView } from './dashboard/components';
...
export default function DashboardPage({
  ...
  if (!isImportMode && !cbom) {
    return (
      <WelcomeView
        cbomUploads={cbomUploads}
        uploadsLoading={uploadsLoading}
        onUpload={onUpload}
        onLoadSample={onLoadSample}
        onLoadCbomUpload={onLoadCbomUpload}
      />
    );
  }
