...
export const INTEGRATION_CATALOG: IntegrationTemplate[] = [
  {
    ...
    fields: [
      // ── GitHub Actions: Repository Connection ──
      {
        ...
        required: true,
        helpText: "GitHub repository (e.g., acme/my-app)",
      },
      {
        key: "githubToken",
        label: "GitHub Token",
        ...
        required: true,
        helpText:
          "Personal access token with actions:read and actions:write scope",
      },
      ...
      // ── Workflow Configuration Section ──
      {
        ...
        type: "section-header",
        required: false,
        helpText: "Configure your GitHub Actions workflow for CBOM scanning",
      },

      {
        ...
        helpText: "Branches to run the workflow on (default: main)",
      },

      {
        ...
        type: "multi-select",
        required: false,
        helpText: "When should the workflow run?",
...

      {
        ...
        required: false,
        helpText:
          'Cron expression for scheduled runs (e.g., "0 2 * * 1" = every Monday at 2 AM UTC)',
        visibleWhen: { field: "triggers", values: ["schedule"] },
      },

      {
        ...
        defaultValue: "json",
        helpText:
          "CBOM output format — SARIF enables GitHub Security tab integration",
        options: [
...

      {
        ...
        label: "Artifact Name",
        type: "text",
        placeholder: "cbom-report",
        required: false,
        helpText: "Name of the uploaded artifact (default: cbom-report)",
      },

      // ── Sonar Integration ──
      {
        key: "sonarEnabled",
        label: "Enable IBM sonar-cryptography deep analysis",
        type: "checkbox",
        required: false,
        defaultValue: "false",
        helpText:
          "Add SonarQube or SonarCloud analysis step to the workflow. Requires a SonarQube server reachable from the runner.",
      },
      {
        key: "_sonarInfo",
        label: "SonarQube Setup",
        type: "info-panel",
        required: false,
        variant: "tip",
        content:
          "**By default, the action uses a fast built-in regex scanner.** Enabling this adds IBM sonar-cryptography deep analysis via SonarQube.\n\n1. Add `SONAR_HOST_URL` and `SONAR_TOKEN` to your repository secrets\n2. Your SonarQube must be reachable from the runner (use self-hosted for internal servers)\n3. For Java projects, add a build step before scanning for bytecode-level insights\n\n**Resources:**\n- [IBM Sonar Cryptography Plugin](https://github.com/IBM/sonar-cryptography)\n- [SonarCloud Setup Guide](https://docs.sonarcloud.io/getting-started/github/)\n- [SonarQube GitHub Actions](https://docs.sonarsource.com/sonarqube/latest/analyzing-source-code/ci-integration/github-actions/)",
      ...
      },
      {
        ...
        required: false,
        helpText:
          "IBM sonar-cryptography currently supports Java, Python, and Go for deep analysis",
        defaultValue: "java",
        options: [
      ...
      // ── Runner Configuration (under Sonar — SonarQube typically requires self-hosted) ──
      {
        ...
        label: "Use self-hosted runner",
        type: "checkbox",
        required: false,
        defaultValue: "true",
        helpText:
          "Internal SonarQube servers are not reachable from GitHub-hosted runners — use a self-hosted runner on the same network",
        visibleWhen: { field: "sonarEnabled", values: ["true"] },
      },
      {
        key: "runnerLabel",
        ...
        required: false,
        helpText: "Comma-separated labels for your self-hosted runner",
        visibleWhen: { field: "selfHostedRunner", values: ["true"] },
      },

      // ── PQC Threshold ──
      {
        key: "pqcThresholdEnabled",
        label: "Enforce PQC readiness threshold",
        type: "checkbox",
        required: false,
        defaultValue: "false",
        helpText:
          "Fail the workflow if post-quantum cryptography readiness is below the threshold",
      },
      {
        key: "pqcThreshold",
        label: "Minimum PQC-safe percentage",
        type: "number",
        required: false,
        defaultValue: "80",
        placeholder: "80",
        ...
        suffix: "%",
        helpText:
          "Workflow will fail if the percentage of quantum-safe components is below this value",
        visibleWhen: { field: "pqcThresholdEnabled", values: ["true"] },
      },

      {
        key: "uploadToRelease",
        label: "Attach CBOM to GitHub Releases",
        type: "checkbox",
        required: false,
        defaultValue: "false",
      ...
      // ── Advanced Settings ──
      {
        ...
        required: false,
        collapsed: true,
        helpText: "Additional workflow customization options",
      },
      {
        key: "excludePaths",
        ...
        type: "tags",
        required: false,
        placeholder: "e.g. vendor/**, test/**, docs/**",
        helpText: "Glob patterns of files/directories to exclude from scanning",
      },
      {
        key: "retentionDays",
        ...
        max: 400,
        suffix: "days",
        helpText: "How long to keep the CBOM artifact in GitHub",
      },
      {
        key: "failOnError",
        label: "Fail workflow on scan errors",
        type: "checkbox",
        required: false,
        defaultValue: "true",
  ...
  },
  {
    ...
    docsUrl:
      "https://docs.digicert.com/en/trust-lifecycle-manager/manage-certificates/certificate-api.html",
    capabilities: [
    ...
    fields: [
      {
        ...
        label: "API Base URL",
        type: "url",
        placeholder: "https://one.digicert.com",
        required: true,
        helpText: "Your DigiCert ONE tenant URL",
      },
      {
        key: "apiKey",
        label: "API Key",
      ...
      },
      {
        ...
        label: "Division ID",
        type: "text",
        placeholder: "Optional — leave blank for all divisions",
        required: false,
        helpText: "Restrict import to a specific division",
      },
      {
        key: "accountId",
        label: "Account ID",
        type: "text",
        placeholder: "Your DigiCert account ID",
        required: true,
        helpText: "Found under Admin → Account Settings",
      },
      {
        key: "apiPath",
        label: "API Path",
      ...
      },
      {
        ...
        required: false,
        helpText:
          "Enable for self-signed or internal CA certificates (e.g. on-prem deployments)",
        options: [
          { value: "false", label: "No — verify TLS certificates (default)" },
          {
            value: "true",
            label: "Yes — skip TLS verification (internal/dev)",
          },
        ],
      },
    ],
    scopeOptions: [
      {
        value: "certificates",
        label: "Certificates",
        description: "TLS, CA, and private certificates from managed PKI",
      },
      {
        value: "endpoints",
        label: "Endpoints",
        description: "Hosts and IPs discovered via network & cloud scans",
      },
      {
        value: "keys",
        label: "Keys",
        description: "Key algorithms, strength, and lifecycle data",
      },
      {
        value: "ca-hierarchies",
        label: "CA Hierarchies",
        description: "Intermediate & root CA chain mappings",
      },
    ],
  ...
  // },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Device Group",
        type: "text",
        placeholder: "Optional — filter by device group",
        required: false,
      },
    ],
    scopeOptions: [
      {
        value: "device-certificates",
        label: "Device Certificates",
        description: "IoT/OT device identity certificates",
      },
      {
        value: "devices",
        label: "Devices",
        description: "Device records, enrollment status, and profiles",
      },
      {
        value: "firmware",
        label: "Firmware",
        description: "Firmware versions and signing verification data",
      },
      {
        value: "device-groups",
        label: "Device Groups",
        description: "Logical groupings and enrollment profiles",
      },
    ],
  ...
  },
  {
    ...
    fields: [
      {
        key: "targets",
        label: "Target CIDR Ranges",
        type: "text",
        placeholder: "10.0.0.0/24, 192.168.1.0/24",
        required: true,
        helpText: "Comma-separated CIDR ranges to scan",
      },
      {
        key: "ports",
        label: "Port Ranges",
        type: "text",
        placeholder: "443, 8443, 636, 993, 995",
        required: true,
        helpText: "Ports to probe for TLS. Common: 443, 8443, 636 (LDAPS)",
      },
      {
        key: "concurrency",
        ...
        type: "select",
        required: true,
        helpText: "Higher concurrency = faster scan but more network load",
        options: [
          { value: "10", label: "10 (Conservative)" },
          { value: "50", label: "50 (Moderate)" },
          { value: "100", label: "100 (Aggressive)" },
        ],
      },
      {
        key: "timeout",
        ...
        type: "select",
        required: true,
        helpText: "Timeout per TLS handshake attempt",
        options: [
          { value: "5", label: "5s" },
          { value: "10", label: "10s" },
          { value: "30", label: "30s" },
    ...
    scopeOptions: [
      {
        value: "endpoints",
        label: "Endpoints",
        description: "TLS-enabled hosts, IPs, and port configurations",
      },
      {
        value: "certificates",
        label: "Certificates",
        description: "Certificate chains extracted from TLS handshakes",
      },
      {
        value: "cipher-suites",
        label: "Cipher Suites",
        description: "Supported cipher suites per endpoint",
      },
      {
        value: "key-exchange",
        label: "Key Exchange",
        description: "KEX algorithms (ECDHE, X25519, ML-KEM, etc.)",
      },
    ],
    defaultScope: [
      "endpoints",
