...
| [Scanning](docs/scanning.md) | Code scanning (8 languages, 1000+ patterns), network TLS scanning, variable resolution, config/artifact scanning, third-party dependency scanning, PQC readiness verdicts |
