...
| [Scanning](docs/scanning.md) | Code scanning (8 languages, 1000+ patterns), certificate file scanning, network TLS scanning, external tool integration (cbomkit-theia), variable resolution (7 strategies), config/artifact scanning, third-party dependency scanning, PQC readiness verdicts, informational asset filtering |
